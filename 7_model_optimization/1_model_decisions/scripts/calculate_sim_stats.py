...
# define functions
def is_valid_data(obs, sim):
    # Remove any paired values where either obs or sim is NaN
...
# Apply similar modifications to get_KGEp, get_NSE, get_MAE, and get_RMSE
...
if __name__ == '__main__':
    ...
    if np.isnan(score):
        print(f"Warning: {obj_fun} calculation resulted in NaN. Check your data.")
        score = -np.inf  # or some other value to indicate a bad fit
