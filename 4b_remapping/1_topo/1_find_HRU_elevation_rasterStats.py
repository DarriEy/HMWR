...
# Finds the mean elevation of each HRU using rasterstats.
...
#controlFolder = Path('/Users/darrieythorsson/compHydro/code/CWARHM/0_control_files')
...
try:
    ...
    with rasterio.open(raster_path) as src:
        ...
        dem_data = src.read(1)  # Assuming the data is in the first band
    ...
    # Rename the 'mean' column to 'elev_mean'
    result_df = result_df.rename(columns={'mean': 'elev_mean'})
