...
ncdir        = '/Users/darrieythorsson/compHydro/data/CWARHM_data/domain_Yukon/simulations/run_Yukon_Merit_1/SUMMA'
file_pattern =  '*_day.nc'
summa_runoff = 'Run_1_Yukon_MERIT_day.nc'
...
# write output    
# with nc.Dataset(os.path.join(ncdir, outfilelist[0])) as src:nano S
